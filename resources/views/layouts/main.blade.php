...
<head>
  ...
  <title>@yeild('titulo-pagina')</title>
  <!-- plugins:css -->
            ...
            <div class="nav-link">
              <div class="user-wrapper">
                ...
                <div class="text-wrapper">
                  <p class="profile-name">@yield('nome-usuario-side')</p>
                  <div>
                    <small class="designation text-muted">@yield('tipo-usuario-side')</small>
